...
#Real GDP
plot(1:s.N,[0 (sim_fun.GDP_Laspeyres[2:s.N]./sim_0.GDP .-1)']',title= "GDP Laspeyres baseline weighted 1 tau")


#Capital
plot(1:s.N,[0 (sim_fun.K[2:s.N]./sim_0.K.-1)']', title="K baseline weighted 1 tau")
